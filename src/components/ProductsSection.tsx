...
import { Plus, Check, ArrowRight, X, Sparkles, MapPin, Package } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 md:mb-24 space-y-4">
          ...
          <p className="text-gray-600 font-sans text-base">
            We operate strict quality-assurance testing on all items. Click any category below to view our comprehensive commercial list, pack sizes, origins, and add items to your quote.
          </p>
        </div>
        ...
        {selectedCategory && (
          <div className="fixed inset-0 z-50 flex items-center justify-end overflow-hidden">
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto p-8 space-y-6">
                <div className="space-y-1">
                  ...
                  <p className="text-gray-500 font-sans text-xs leading-relaxed">
                    Select individual produce items below to add them to your custom quote request. Once you are finished, click "Request My Quote" to submit your specifications directly to our sales coordinators.
                  </p>
                </div>
                    ...
                    return (
                      <div
                        ...
                        className={`p-5 rounded-2xl border transition-all duration-300 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 ${
                          isSelected
                            ? "bg-forest/5 border-forest/30 shadow-sm"
                      ...
                      >
                        ...
                        <button
                          ...
                          className={`flex items-center justify-center gap-2 font-display text-xs font-bold py-2.5 px-4 rounded-xl transition-all duration-300 cursor-pointer min-w-[125px] ${
                            isSelected
                              ? "bg-forest text-white"
                              : "bg-light-grey text-charcoal hover:bg-leaf hover:text-white"
                          }`}
                        >
                          {isSelected ? (
                            <>
              ...
              {/* Drawer Bottom Persistent CTA bar */}
              <div className="shrink-0 p-6 border-t border-gray-100 bg-gray-50 flex flex-col sm:flex-row items-center justify-between gap-4">
                <div className="text-left">
                  <span className="font-sans text-xs text-gray-500">
                    ITEMS ADDED TO QUOTE
                  </span>
                  <p className="font-display font-extrabold text-lg text-charcoal leading-none mt-1">
                ...
                <div className="flex items-center gap-3 w-full sm:w-auto">
                  <button
                    onClick={() => setSelectedCategory(null)}
                    className="w-full sm:w-auto text-center font-display text-sm font-semibold text-gray-500 hover:text-charcoal py-3 px-5 cursor-pointer"
                  >
                    Close List
                  </button>
                  ...
                  <button
                    ...
                    className="w-full sm:w-auto flex items-center justify-center gap-2 font-display text-sm font-bold bg-forest text-white py-3 px-6 rounded-xl hover:bg-forest-hover shadow-md cursor-pointer"
                  >
